...
urlpatterns = [
    ...
    path(route='project_list', view = views.ProjectListView.as_view(), name = 'project_list'),
    ...
    path(route='options_project', view = views.ProjectListView.as_view(), name = 'options_project'),
